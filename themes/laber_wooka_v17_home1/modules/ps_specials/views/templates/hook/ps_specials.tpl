...
<div class="ipadProFull col-lg-7 col-md-12 col-sm-12 col-xs-12">

	<div class="laberSpecialP">
		{*<div class="title_block">
			<h3>
				<span class="strong">{l s='Top Flash ' d='Shop.Theme.Laberthemes'}<span>{l s='Deals' d='Shop.Theme.Laberthemes'}</span></span>
			</h3>
		</div>*}
