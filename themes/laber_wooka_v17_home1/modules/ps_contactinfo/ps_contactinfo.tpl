...
<div class="block-contact col-lg-2 col-md-3 col-sm-6 col-xs-12 links wrapper">
	{hook h="logoFooter"}
    <p class="h3 text-uppercase block-contact-title hidden-sm-down">{l s='Store information' d='Shop.Theme.Global'}</p>
	...
	<div id="footer_sub_menu_contactFooter" class="collapse">
	  {if $contact_infos.address.address1}
		<p class="address address1">{$contact_infos.address.address1}</p>
	  {/if}
