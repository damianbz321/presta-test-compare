	...
	<div class="kr_blog_post_area">
		<div class="kr_blog_post_inner blog_style_{$xipblogsettings.blog_style} column_{$xipblogsettings.blog_no_of_col}">
			{foreach from=$xipblogpost item=xpblgpst}
				<article id="blog_post" class="blog_post blog_post_{$xpblgpst.post_format}">
					<div class="blog_post_content">
						<div class="blog_post_content_top">
							<div class="post_thumbnail">
                                                            <a href="{$xpblgpst.link}" style="display:block;position: relative;z-index: 10;">
								...
								{if $xpblgpst.post_format == 'video'}
									...
									{/if}
									{include file="module:xipblog/views/templates/front/default/post-video.tpl" postvideos=$postvideos width='800' height="800" class=$class}
						...
						<div class="blog_post_content_bottom">
							...
							<div class="post_content">
								{if isset($xpblgpst.post_excerpt) && !empty($xpblgpst.post_excerpt)}
									{$xpblgpst.post_excerpt|truncate:200:'...'|escape:'html':'UTF-8'}
								{else}
									{$xpblgpst.post_content|truncate:200:'...'|escape:'html':'UTF-8'}
								{/if}
							</div>
