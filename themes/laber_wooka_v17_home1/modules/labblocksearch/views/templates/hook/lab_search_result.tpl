...
<div class="search-title">
	{l s='The result search for ' d='Shop.Theme.Laberthemes'} "{$query|escape:'quotes':'UTF-8'}" <span>({$search_Total|escape:'quotes':'UTF-8'} {l s=' results have been found.' d='Shop.Theme.Laberthemes'})</span>
...
{$num = 0}
	...
	{else}
	<p class="noresult">{l s='No found any item!' d='Shop.Theme.Laberthemes'}</p>
{/if}
</ul>
{if $search_Total > $limit_item}
<p class="title_showall_text">{l s='Search limited to ' d='Shop.Theme.Laberthemes'} {$limit_item|escape:'quotes':'UTF-8'} {l s='products' d='Shop.Theme.Laberthemes'}</p>
<p class="title_showall">
<a href="#" onclick="Show_All_Search();return false;">
	<span>{l s='show alls' d='Shop.Theme.Laberthemes'}</span>
	</a>
</p>
{/if}
</div>
