...
{foreach from=$group_cat_result item=group_cat name=group_cat_result}
	{if $group_cat.type_display == 'accordion'}
		{include file="./labproductcategory_accordion.tpl" group_cat_info = $group_cat.cat_info}
	{/if}
	{if $group_cat.type_display == 'accordion-banner'}
		{include file="./labproductcategory_accordion-banner.tpl" group_cat_info = $group_cat.cat_info}
	{/if}
