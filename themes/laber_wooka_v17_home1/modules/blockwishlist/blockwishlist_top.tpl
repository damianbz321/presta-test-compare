...
<div id="_desktop_wishtlistTop" class="pull-right">
	<div class="laberwishtlistTop">
		<a class="wishtlist_top icon" href="{$link->getModuleLink('blockwishlist', 'mywishlist', array(), true)|escape:'html':'UTF-8'}">
			<i class="icon_wishtlist  icon-heart"></i>	
			{*<span>{l s='Wishlist' d='Shop.Theme.Laberthemes'}</span>*}
			{if $count_product > 0}
