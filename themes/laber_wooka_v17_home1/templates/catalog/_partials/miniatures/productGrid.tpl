  ...
  {assign var="attribute" value=$product.attributes|reset}
    ...
    <div class="laber-product-description">
		{block name='product_name'}
			<h2 class="productName" itemprop="name"><a href="{$product.url}"><b>{$product.name} {if $attribute.name}({$attribute.name}){/if}</b></a></h2>
		{/block}
			...
			{block name='product_price_and_shipping'}
				{if $product.show_price}
				  <div class="laber-product-price-and-shipping">
					  <span itemprop="price" class="price" style="color: #cc1414;font-size:17px;"><b>{$product.price}</b></span>
