...
<div class="item product-box  ajax_block_product js-product-miniature" data-id-product="{$product.id_product|escape:'quotes':'UTF-8'}" data-id-product-attribute="{$product.id_product_attribute|escape:'quotes':'UTF-8'}">
	<div class="product-container">	
		<div class="laber-mediaBody">
			<div class="laber-image pull-left">
			...
			<div class="laber-content laber-mediaBody">
				<h5 class="product-name"><a href="{$product.link|escape:'html':'UTF-8'}">{$product.name|truncate:15:''|escape:'html':'UTF-8'}</a></h5>
				...
				<div class="product-quick-view">		
					<a href="javascript:void(0);" class="quick-view quickview" data-toggle="tooltip" data-placement="top" data-link-action="quickview" title="quickview" rel="#">
					<span class="text">{l s='Quick view'}</span>
					</a>
				</div>							
			 </div>
		</div>	
