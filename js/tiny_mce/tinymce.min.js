// 4.9.11 (2020) MODIFIED STATUSBAR = FALSE | 2019-04-16 FONTFAMILY FIX
...
((typeof(tinymcepro_sizes) === 'undefined') ? tinymcepro_sizes='':'');
((typeof(tinymcepro_contentstyle) === 'undefined') ? tinymcepro_contentstyle='':'');
((typeof(tinymcepro_autoresize) === 'undefined') ? tinymcepro_autoresize='':'');
((typeof(tinymcepro_adv_bootstrap) === 'undefined') ? tinymcepro_adv_bootstrap='':'');
((typeof(tinymcepro_contextmenu) === 'undefined') ? tinymcepro_contextmenu='':'');
((typeof(tinymcepro_templates) === 'undefined') ? tinymcepro_templates='':'');
((typeof(tinymcepro_adv_bootstrap_toolbar) === 'undefined') ? tinymcepro_adv_bootstrap_toolbar='':'');
((typeof(tinymcepro_fonts) === 'undefined') ? tinymcepro_fonts='':'');
((typeof(tinymcepro_lineheight) === 'undefined') ? tinymcepro_lineheight='':'');
((typeof(tinymcepro_force_br_newlines) === 'undefined') ? tinymcepro_force_br_newlines='':'');
((typeof(tinymcepro_newlines_to_brs) === 'undefined') ? tinymcepro_newlines_to_brs='':'');
((typeof(tinymcepro_force_p_newlines) === 'undefined') ? tinymcepro_force_p_newlines='':'');
((typeof(tinymceproHeight) === 'undefined') ? tinymceproHeight='':'');
((typeof(tinymceproImgClassArray) === 'undefined') ? tinymceproImgClassArray='':'');
((typeof(tinymcepro_minifycode) === 'undefined') ? tinymcepro_minifycode='':'');
((typeof(tinymcepro_template_files) === 'undefined') ? tinymcepro_template_files='{}':'');
