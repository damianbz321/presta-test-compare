    ...
    <div class="phdescription-admin-footer">
        {if !empty($list)}
            {*<div class="item header">
                <div class="row">
                    <div class="col-lg-2">{l s='ID description' mod='phdescription'}</div>
                    <div class="col-lg-4">{l s='Item type' mod='phdescription'}</div>
                    <div class="col-lg-2">{l s='Position' mod='phdescription'}</div>
                    <div class="col-lg-4">{l s='Actions' mod='phdescription'}</div>
                </div>
            </div>*}
...
{*                                                        <label class="form-control-label">[{$lang.iso_code|strtoupper}] {l s='Insert a image' mod='phdescription'}:</label>*}
{*                                                        <input type="file" class="form-control" name="phdescription[image_file3]" id="input_file" data-action="{$addFileUrl}" data-idp="{$id_product}" data-idd="" data-type="3" />*}
...
{*        <input type="hidden" name="phdescription[id_product]" value="{$id_product}" />*}
{*        <input type="hidden" name="phdescription[type]" value="" class="phtype" />*}
{*        <input type="hidden" name="phdescription[id_description]" value="" class="ph_id_description" />*}
        <div class="phdescription-admin-form-create"></div>
    </div>
    <div class="phdescription-admin-header">
        <button type="button" class="btn btn-success addNewElement"><i class="material-icons">add_circle_outline</i> {l s='Add new element' mod='phdescription'}</button>
