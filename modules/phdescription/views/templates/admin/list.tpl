...
{*                    <p class="head">{l s='1 column - big text' mod='phdescription'}</p>*}
                    <fieldset class="form-group">
                        <div class="row">
                            {foreach $languages as $key => $lang}
                                <div class="col-md-12 langBox lang-{$lang.iso_code}{if $key > 0} hidden{/if}">
                                    ...
                                    <textarea name="phdescriptionE[{$ki}][text][{$lang.id_lang}]" class="form-control autoload_rte2" >{$l.lang[$lang.id_lang].text}</textarea>
                                </div>
                            {/foreach}
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                {foreach $languages as $key => $lang}
                                    <div class="langBox lang-{$lang.iso_code}{if $key > 0} hidden{/if}">
                                        <label class="form-control-label">[{$lang.iso_code|strtoupper}] {l s='Insert a text' mod='phdescription'}:</label>
                                        <textarea name="phdescriptionE[{$ki}][text3][{$lang.id_lang}]" class="form-control autoload_rte2" >{$l.lang[$lang.id_lang].text}</textarea>
                                    </div>
                                {/foreach}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {foreach $languages as $key => $lang}
                                    <div class="langBox lang-{$lang.iso_code}{if $key > 0} hidden{/if}">
                                        <label class="form-control-label">[{$lang.iso_code|strtoupper}] {l s='Insert a text' mod='phdescription'}:</label>
                                        <textarea name="phdescriptionE[{$ki}][text4][{$lang.id_lang}]" class="form-control autoload_rte2" >{$l.lang[$lang.id_lang].text}</textarea>
                                    </div>
                                {/foreach}
                            </div>
                            <div class="col-md-6">
                    ...
                    <fieldset class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                {foreach $languages as $key => $lang}
                                    <div class="langBox lang-{$lang.iso_code}{if $key > 0} hidden{/if}">
                                        <label class="image-box" for="input_file-{$l.id_description}a" data-idp="{$id_product}" data-type="5" data-idd="{$l.id_description}" data-ty="a"><i class="fas fa-image"></i></label>
                                        <input type="file" class="form-control input_file input_file-{$l.id_description}a" name="phdescription[image_file5]" id="input_file-{$l.id_description}a" data-idd="{$l.id_description}" data-ty="a" data-action="{$addFileUrl}" data-idp="{$id_product}" data-type="5" style="display: none;visibility: hidden;" />
                            ...
                            <div class="col-md-6">
                                {foreach $languages as $key => $lang}
                                    <div class="langBox lang-{$lang.iso_code}{if $key > 0} hidden{/if}">
                                        <label class="image-box" for="input_file-{$l.id_description}b" data-idp="{$id_product}" data-type="6" data-idd="{$l.id_description}" data-ty="a"><i class="fas fa-image"></i></label>
                                        <input type="file" class="form-control input_file input_file-{$l.id_description}b" name="phdescription[image_file6]" id="input_file-{$l.id_description}b"  data-idd="{$l.id_description}" data-ty="b" data-action="{$addFileUrl}" data-idp="{$id_product}" data-type="6" style="display: none;visibility: hidden;" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {foreach $languages as $key => $lang}
                                    <div class="langBox lang-{$lang.iso_code}{if $key > 0} hidden{/if}">
                                        <label class="form-control-label">[{$lang.iso_code|strtoupper}] {l s='Insert a text' mod='phdescription'}:</label>
                                        <textarea name="phdescriptionE[{$ki}][text6][{$lang.id_lang}]" class="form-control autoload_rte2" >{$l.lang[$lang.id_lang].text}</textarea>
                                    </div>
                                {/foreach}
                            </div>
                            <div class="col-md-6">
                                {foreach $languages as $key => $lang}
                                    <div class="langBox lang-{$lang.iso_code}{if $key > 0} hidden{/if}">
                                        <label class="form-control-label">[{$lang.iso_code|strtoupper}] {l s='Insert a text' mod='phdescription'}:</label>
                                        <textarea name="phdescriptionE[{$ki}][text7][{$lang.id_lang}]" class="form-control autoload_rte2" >{$l.lang[$lang.id_lang].text2}</textarea>
                                    </div>
                                {/foreach}
                            </div>
                        </div>
