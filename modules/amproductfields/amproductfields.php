...
class AmProductFields extends Module {
    ...
    public function hookDisplayAdminProductsMainStepLeftColumnMiddle($params) {
        ...
        $test = $product->custom_field_lang_wysiwyg['1'];
        
        
        //$this->context->smarty->assign('custom_field_lang_wysiwyg', $product->custom_field_lang_wysiwyg[1]);
        $this->context->smarty->assign('custom_field_lang_wysiwyg',$test);
