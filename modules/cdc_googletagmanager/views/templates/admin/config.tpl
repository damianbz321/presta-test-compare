			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane active panel" id="tagmanager">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="control-label col-lg-3" for="CDC_GTM_DATALAYER_FORMAT">{l s='Datalayer format' mod='cdc_googletagmanager'}</label>
							<div class="margin-form col-lg-3 form-inline">
								<select class="form-control" id="CDC_GTM_DATALAYER_FORMAT" name="CDC_GTM_DATALAYER_FORMAT">
									{foreach from=$CDC_GTM_DATALAYER_FORMAT_LIST key=k item=v}
										<option value="{$k}" {if $k == $CDC_GTM_DATALAYER_FORMAT}selected="selected"{/if}>{$v|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="col-lg-6">
								<p class="cdc-info">{l s='Datalayer format (Classic UA or GA4)' mod='cdc_googletagmanager'}</p>
							</div>
						</div>
							...
							<div class="margin-form col-lg-3 form-inline">
								<select class="form-control" id="CDC_GTM_DATA_LANGUAGE" name="CDC_GTM_DATA_LANGUAGE">
									{foreach from=$CDC_GTM_DATA_LANGUAGES key=k item=v}
										<option value="{$k}" {if $k == $CDC_GTM_DATA_LANGUAGE}selected="selected"{/if}>{$v|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="col-lg-6"></div>
							...
							<div class="margin-form col-lg-3 form-inline">
								<select class="form-control" id="CDC_GTM_PRODUCT_ID_FIELD" name="CDC_GTM_PRODUCT_ID_FIELD">
									{foreach from=$CDC_GTM_ID_TYPES item='product_id_field'}
										<option value="{$product_id_field}" {if $product_id_field == $CDC_GTM_PRODUCT_ID_FIELD}selected="selected"{/if}>{$product_id_field|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="col-lg-6"></div>
							...
							<div class="margin-form col-lg-3 form-inline">
								<select class="form-control" id="CDC_GTM_DISPLAY_VARIANT_ID" name="CDC_GTM_DISPLAY_VARIANT_ID">
									{foreach from=$CDC_GTM_DISPLAY_VARIANT_ID_LIST key=k item=v}
										<option value="{$k}" {if $k == $CDC_GTM_DISPLAY_VARIANT_ID}selected="selected"{/if}>{$v|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="col-lg-6">
						...
						<div class="form-group">
							...
							<div class="margin-form col-lg-3 form-inline">
								...
								<select class="form-control" id="CDC_GTM_PRODUCT_NAME_FIELD" name="CDC_GTM_PRODUCT_NAME_FIELD">
									...
									<option value="{$product_name_field}" {if $product_name_field == $CDC_GTM_PRODUCT_NAME_FIELD}selected="selected"{/if}>{$product_name_field|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="col-lg-6"></div>
						...
						<div class="form-group">
							...
							<div class="margin-form col-lg-3 form-inline">
								...
								<select class="form-control" id="CDC_GTM_CATEGORY_NAME_FIELD" name="CDC_GTM_CATEGORY_NAME_FIELD">
									...
									<option value="{$category_name_field}" {if $category_name_field == $CDC_GTM_CATEGORY_NAME_FIELD}selected="selected"{/if}>{$category_name_field|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="col-lg-6"></div>
							...
							<div class="margin-form col-lg-3 form-inline">
								<select class="form-control" id="CDC_GTM_CUSTOMER_INFORMATIONS" name="CDC_GTM_CUSTOMER_INFORMATIONS">
									{foreach from=$CDC_GTM_CUSTOMER_INFORMATIONS_ID_LIST key=k item=v}
										<option value="{$k}" {if $k == $CDC_GTM_CUSTOMER_INFORMATIONS}selected="selected"{/if}>{$v|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="col-lg-6">
						...
						<div class="form-group">
							...
							<div class="margin-form col-lg-3 form-inline">
								<select class="form-control" id="CDC_GTM_REMARKETING_PRODUCTID" name="CDC_GTM_REMARKETING_PRODUCTID">
									...
									<option value="{$product_identifier}" {if $product_identifier == $CDC_GTM_REMARKETING_PRODUCTID}selected="selected"{/if}>{$product_identifier|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="col-lg-6"></div>
						...
						<div class="form-group">
							<label class="control-label col-lg-3" for="CDC_GTM_GOOGLE_SCRIPT_SERVER_URL">{l s='Google Tag Manager script URL' mod='cdc_googletagmanager'}</label>
							<div class="margin-form col-lg-3">
								<input type="url" class="form-control" id="CDC_GTM_GOOGLE_SCRIPT_SERVER_URL" name="CDC_GTM_GOOGLE_SCRIPT_SERVER_URL" value="{$CDC_GTM_GOOGLE_SCRIPT_SERVER_URL|escape:'htmlall':'UTF-8'}" placeholder="https://www.googletagmanager.com/gtm.js" />
							</div>
							<div class="col-lg-6">
								<p class="cdc-info">{l s='In order to load the Google Tag Manager code from your own server instead of www.googletagmanager.com/gtm.js, please fill in here the url of the gtm.js script.' mod='cdc_googletagmanager'}</p>
							</div>
						</div>
						...
						<a href="{$gtm_order_logs_url}" class="btn btn-default">{l s='Orders sent to GTM (GTM Orders)' mod='cdc_googletagmanager'}</a>
						...
						<div style="margin: 30px 0 6px 0;">
							...
							{else}
								- <a href="{$form_action}&empty_resend_queue">{l s='Empty resend queue' mod='cdc_googletagmanager'}</a>
								<pre>{$ORDER_RESEND_Q}</pre>
							{/if}
						</div>
						...
						<div style="margin: 15px 0 6px 0;">
							...
							{if empty({$REFUNDS_Q})}
								: {l s='Empty' mod='cdc_googletagmanager'}
							{else}
								- <a href="{$form_action}&empty_refund_queue">{l s='Empty refund queue' mod='cdc_googletagmanager'}</a>
								<pre>{$REFUNDS_Q}</pre>
							{/if}
						</div>
					</div>
