...
{
    public $strApiSecret   = null;
    public $strApiKey      = null;
        ...
        if ($this->httpCode != 200) {
            ...
            if (is_array($this->errors)) {
                foreach ($this->errors as $arrError) {
                    throw new FreshMailRestException($arrError['message'], $arrError['code']);
                } // endforeach
            } // endif
        } // endif
...
class FreshMailRestException extends Exception
{
}
