...
{foreach from=$blocksProductFooter item=block}
    ...
    {else}
        <div id="ppbContainer{$block->id|escape:'int':'utf-8'}" class="zonetheme featured-products block products_block clearfix {if $block->carousell==1}ppbContainerBlockMainDiv ppbCarouselBlock{/if}" {if $block->block_position == 2}style="display:none;"{/if}>
                ...
                document.addEventListener("DOMContentLoaded", function (event) {
                    $.fancybox({
                        ...
                        'afterShow': function () {
                            ...
                            var {/literal}ppb{$block->id|escape:'int':'utf-8'}{literal} = $('.fancybox-inner #{/literal}ppb{$block->id}{literal} .productsCarousel').lightSlider(
                                {
