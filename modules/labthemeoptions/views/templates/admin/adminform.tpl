					...
					<form class="form-horizontal" action = "{$action}"  enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
									...
									<div class="cl-tr cl-tr-style">
                                        ...
                                        <div class="cl-td-l cl-td-layout cl-td-layout1{if $labthemecolor=='color1' } active {/if} "id="color1"><a href="javascript:void(0)"  title=""><span class="cl1"></span><span class="cl2"></span>{l s='color1'}</a></div>
                                        <div class="cl-td-l cl-td-layout cl-td-layout2{if $labthemecolor=='color2' } active {/if}" id="color2"><a href="javascript:void(0)"  title=""><span class="cl1"></span><span class="cl2"></span>{l s='color2'}</a></div>
                                    </div>
                                    <div class="cl-tr cl-tr-style">
                                        <div class="cl-td-l cl-td-layout cl-td-layout3 {if $labthemecolor=='color3' } active {/if}" id="color3"><a href="javascript:void(0)"  title=""><span class="cl1"></span><span class="cl2"></span>{l s='color3'}</a></div>
                                        <div class="cl-td-l cl-td-layout cl-td-layout4 {if $labthemecolor=='color4' } active {/if}" id="color4"><a href="javascript:void(0)"  title=""><span class="cl1"></span><span class="cl2"></span>{l s='color4'}</a></div>
                                    </div>
                                    <div class="cl-tr cl-tr-style">
                                        <div class="cl-td-l cl-td-layout cl-td-layout5 {if $labthemecolor=='color5' } active {/if}" id="color5"><a href="javascript:void(0)"  title=""><span class="cl1"></span><span class="cl2"></span>{l s='color5'}</a></div>
                                        <div class="cl-td-l cl-td-layout cl-td-layout6 {if $labthemecolor=='color6' } active {/if}"  id="color6"><a href="javascript:void(0)" title=""><span class="cl1"></span><span class="cl2"></span>{l s='color6'}</a></div>
                                    </div>
									<!-- <div class="cl-tr cl-tr-style">
                        ...
                        <script type="text/javascript">
                            ...
                            $('#resetbutton').click(function(e){
								...
								$('#color_12').attr("value"," ");
                                $('#color_12').attr("style","background-color:#fff; color: black;");
                            });
                        </script>
                    </form>
				</div>
