...
class myprestacomments extends Module
{
    ...
    protected function _postProcess()
    {
        ...
        if (Tools::isSubmit('submitModerate')) {
            Configuration::updateValue('myprestacomments_share_multi', (int)Tools::getValue('myprestacomments_share_multi'));
            Configuration::updateValue('myprestacomments_inc_rev', (int)Tools::getValue('myprestacomments_inc_rev'));
            Configuration::updateValue('myprestacomments_inc_pr', (int)Tools::getValue('myprestacomments_inc_pr'));
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'desc' => $this->l('Use this option if your shop does not support jsonld structured datas format. Use this option if your product page does not have product structured datas, it creates basic schema.org product snippet'),
                        'name' => 'myprestacomments_inc_pr',
                        'values' => array(
                            array(
                                'id' => 'active_on',
                                'value' => 1,
                    ...
                    array(
                        'type' => 'switch',
                        'is_bool' => true,
                        'label' => $this->l('Create Review structured data'),
                        'desc' => $this->l('Use this option if your shop does not support jsonld structured datas format. This includes "Review" structured data near each comment. Warning: it does not create aggregateRating. You can create it with this plugin: ') . '<a class="label label-danger" href="https://mypresta.eu/modules/seo/product-comments-reviews-rich-snippet.html" target="_blank">aggregateRating + jsonld</a>',
                        'name' => 'myprestacomments_inc_rev',
                        'values' => array(
                            array(
                                'id' => 'active_on',
                                'value' => 1,
                    ...
                    array(
                        'type' => 'switch',
                        'is_bool' => true,
                        'label' => $this->l('Share reviews between shops'),
                        'desc' => $this->l('If you your prestashop with multistore environment active - you can share reviews between shops.'),
                        'name' => 'myprestacomments_share_multi',
                        'values' => array(
                            array(
                                'id' => 'active_on',
                                'value' => 1,
    ...
    {
        return array(
            'myprestacomments_share_multi' => Tools::getValue('myprestacomments_share_multi', Configuration::get('myprestacomments_share_multi')),
            'myprestacomments_inc_rev' => Tools::getValue('myprestacomments_inc_rev', Configuration::get('myprestacomments_inc_rev')),
            'myprestacomments_inc_pr' => Tools::getValue('myprestacomments_inc_pr', Configuration::get('myprestacomments_inc_pr')),
    ...
    public function renderCommentsForm($params)
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'create_snippet' => (bool)Configuration::get('myprestacomments_inc_pr'),
            'create_review_snippet' => (bool)Configuration::get('myprestacomments_inc_rev'),
        ));
