...
class xipblog extends Module implements WidgetInterface
{
	...
	public $all_hooks = array("displayheader","ModuleRoutes","displayBlog");
...
//        }
	...
	public function getWidgetVariables($hookName = null, array $configuration = [])
	{
        ...
        // wp API
        $wp_posts = [];
        $jsonData = json_decode(file_get_contents('https://blog.hifood.pl/wp-json/wp/v2/posts?per_page=5'), true);
        $i = 0;
        ...
        foreach ($jsonData as $post) {
            $wp_posts[] = [
                ...
                'img' => reset($post['yoast_head_json']['og_image'])['url'],
                'content' => $post['content']['rendered'],
                'url' => $post['yoast_head_json']['og_url'],
                'excerpt' => html_entity_decode($post['excerpt']['rendered'], ENT_QUOTES, 'UTF-8'),
