                ...
                array(
                    ...
                    'desc' => '<script>
                           $(document).ready(function(){
                                var numberstrtitle = $("#meta_title_1").val().length;
                                $("#meta_title_1").next("p").css({"float":"left"});
                                $("#meta_title_1").parent("div.col-lg-9").append("<p class=\"meta_title_count\" style=\"float:right;\">"+numberstrtitle+"/70</p>");
                                var number_meta_description_1 = $("#meta_description_1").val().length;
                                $("#meta_description_1").next("p").css({"float":"left"});
                                $("#meta_description_1").parent("div.col-lg-9").append("<p class=\"meta_desc_count\" style=\"float:right;\">"+number_meta_description_1+"/160</p>");
                            
                                if(number_meta_description_1 > 160)
                                {
                                    $(".meta_desc_count").css({"color":"#de1c1c"});
                                }
                                else
                                {
                                    $(".meta_desc_count").css({"color":"#555"});
                                }
                                if(numberstrtitle > 70)
                                {
                                    $(".meta_title_count").css({"color":"#de1c1c"});
                                }
                                else
                                {
                                    $(".meta_title_count").css({"color":"#555"});
                                }


                                $("body").on("input","#meta_title_1", function(){
                                var numberstrtitle = $("#meta_title_1").val().length;
                                var number_meta_description_1 = $("#meta_description_1").val().length;
                                $(".meta_title_count").text(numberstrtitle+"/70");
                                $(".meta_desc_count").text(number_meta_description_1+"/160");
                                if(number_meta_description_1 > 160)
                                {
                                    $(".meta_desc_count").css({"color":"#de1c1c"});
                                }
                                ...
                                $("body").on("input","#meta_description_1", function(){
                                var numberstrtitle = $("#meta_title_1").val().length;
                                var number_meta_description_1 = $("#meta_description_1").val().length;
                                $(".meta_title_count").text(numberstrtitle+"/70");
                                $(".meta_desc_count").text(number_meta_description_1+"/160");
                    ...
                    </script>'.$this->l('Enter Your Post Meta Title for SEO' ),
                    'lang' => true,
                ),
                array(
                    'type' => 'tags',
