...
<?php } ?>
<label class="control-label col-lg-3 field_name">
<?php if($tooltip != '')
{
?>
...
<div class="col-lg-9 ">
<input id="field_<?php echo $id; ?>" name="<?php echo $field_name; ?>" type="checkbox" value="1"<?php if ($value) { ?> checked="checked"<?php } ?> />
</div>
</div>